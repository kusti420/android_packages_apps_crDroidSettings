...
public class DeviceUtils {
    ...
    /*
     * IchthysOS: the org.lineageos.platform-res package (id 0x3f) is not always attached
     * to an app's runtime AssetManager (e.g. it isn't on Cuttlefish), so reads of
     * org.lineageos.platform.internal.R.* resources throw Resources.NotFoundException.
     * These helpers fall back to the lineage-sdk config.xml defaults instead of crashing.
     */
    public static int getLineageInteger(Context context, int resId, int def) {
        try {
    ...
    public static boolean getLineageBoolean(Context context, int resId, boolean def) {
        try {
    ...
    public static float getLineageFloat(Context context, int resId, float def) {
        try {
    ...
    public static int getDeviceKeys(Context context) {
        return getLineageInteger(context,
                org.lineageos.platform.internal.R.integer.config_deviceHardwareKeys, 64);
    }

    public static int getDeviceWakeKeys(Context context) {
        return getLineageInteger(context,
                org.lineageos.platform.internal.R.integer.config_deviceHardwareWakeKeys, 64);
    }
    ...
    public static boolean hasButtonBacklightSupport(Context context) {
        final boolean buttonBrightnessControlSupported = getLineageInteger(context,
                org.lineageos.platform.internal.R.integer
                        .config_deviceSupportsButtonBrightnessControl, 0) != 0;
    ...
    public static boolean hasKeyboardBacklightSupport(Context context) {
        return getLineageInteger(context, org.lineageos.platform.internal.R.integer
                .config_deviceSupportsKeyboardBrightnessControl, 0) != 0;
    }
